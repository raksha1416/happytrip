...
public class Testcase2 extends Baseclass
{
    ...
    Logger log= LogManager.getLogger(Testcase2.class.getName());
 
 @Test(dataProvider ="Login")
 public void ReadData(String userName,String Password) throws IOException, InterruptedException
 {
     ...
     admin.sendPassword(Password);
         //Import "Sign Out" data from the excel.
         Thread.sleep(2000);
         cell =mySheet.getRow(2).getCell(3);
         cell.setCellType(Cell.CELL_TYPE_STRING);
         driver.findElement(By.xpath("//*[@id='global']/li[2]/a"));
		...
		String actual=driver.findElement(By.xpath("//*[@id='global']/li[2]/a")).getText();
 ...
 @DataProvider(name="Login")
	...
	public static Object[][] testData() throws IOException, InterruptedException {
	 ...
	 cell=mySheet.getRow(2).getCell(1);
     cell.setCellType(Cell.CELL_TYPE_STRING);
     Thread.sleep(2000);
     String username=cell.getStringCellValue();
     System.out.println(username);
     cell =mySheet.getRow(2).getCell(2);
     cell.setCellType(Cell.CELL_TYPE_STRING);
