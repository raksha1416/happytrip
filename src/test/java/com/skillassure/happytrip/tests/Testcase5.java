...
public class Testcase5 extends Baseclass
{
    ...
    Logger log= LogManager.getLogger(Testcase5.class.getName());
 ...
 public void ReadData(String userName, String Password) throws IOException
 {
	...
	// importing expected data
		...
		boolean actual=driver.findElement(By.id("flight")).isDisplayed();
 ...
 @DataProvider(name="Login")
	...
	public static Object[][] testData() throws IOException, InterruptedException {
	 ...
	 cell=mySheet.getRow(5).getCell(1);
  cell.setCellType(Cell.CELL_TYPE_STRING);
  Thread.sleep(2000);
  String username=cell.getStringCellValue();
  System.out.println(username);
  cell =mySheet.getRow(5).getCell(2);
  cell.setCellType(Cell.CELL_TYPE_STRING);
